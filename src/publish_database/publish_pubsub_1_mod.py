...
def flatten(ticks):
    ''' Flattens the ticks into a list of list and modifies the timestamp
    to a string. The ohlc items which is recieved as a dictionary is a appended
    to the list
    '''
...
@app.task
def insert_db(prev_ticks,ticks,
    ...
    prev = {}
    next = {}
    print(len(prev_ticks),len(ticks))
    # prev_timestamp = '0'
