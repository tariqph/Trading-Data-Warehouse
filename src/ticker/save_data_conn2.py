...
instrument_list = instrument_list[0:int(n/5)]
# instrument_list = instrument_list[0:1000]

high_low_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..","..",
                                    config['high_low_files']['conn_2']))
...
def on_ticks(ws, ticks):
    ...
    insert_db.apply_async(args = (ticks,
                    ...
                    table_name, filename_data, filename_timestamp,high_low_path), queue=queue)
