...
instrument_list = instrument_list[int(2*n/5):int(3*n/5)]

high_low_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..","..",
                                    config['high_low_files']['conn_4']))
