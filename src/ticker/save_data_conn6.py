...
count = 0
queue = config['rabbitmq']['queues']['six']

def on_ticks(ws, ticks):
   
    print("conn_6",ticks[0]['exchange_timestamp'],len(ticks))
